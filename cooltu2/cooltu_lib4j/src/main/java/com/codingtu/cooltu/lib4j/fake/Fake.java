...
public class Fake {
    ...
    public static BaseEs<String> names() {
        return names(20);
    }

    public static BaseEs<String> names(int size) {
        BaseEs<String> nameEs = Es.es();
    ...
    public static BaseEs<String> namesInNet() {
        return namesInNet(20);
    }

    public static BaseEs<String> namesInNet(int size) {
        BaseEs<String> nameEs = Es.es();
        for (int i = 0; i < size; i++) {
            nameEs.add(nameInNet());
        }
        return nameEs;
    }
    ...
    public static BaseEs<String> images() {
        return images(20);
    }

    public static BaseEs<String> images(int size) {
        BaseEs<String> imageEs = Es.es();
        for (int i = 0; i < size; i++) {
            imageEs.add(image());
        }
        return imageEs;
...
//    }
    ...
    public static BaseEs<String> avatar(int size) {
        return images(size);
    }
